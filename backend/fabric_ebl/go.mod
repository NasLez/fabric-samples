...
require (
	...
	github.com/wxl-server/idl_gen v0.0.0-20250222114420-27d301efc245
...
require (
	...
	github.com/cloudwego/kitex/pkg/protocol/bthrift v0.0.0-20250212064021-6dbce3da0f9a // indirect
